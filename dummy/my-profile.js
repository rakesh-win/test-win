...
import LoyalityPoints from '@/components/My-Profiles/LoyalityPoints'
    ...
    const fetchSignedUser = async () => {
      ...
      try {
        ...
        if (signedRes && signedRes.data[0] && signedRes.data[0].email) {
          axios
            .post(`${process.env.NEXT_PUBLIC_API}/assignpoints`, {
              email: signedRes.data[0].email,
              userid: signedRes.data[0].id
            })
            .then(res => {
            ...
            <div className='col-lg-12'>
              <Box sx={{ 'min-height': '200px', borderColor: 'divider' }}>
                ...
                <TabPanel value={value} index={1}>
                  {/* <LoyalityPoints enrolledCourses={enrolledCourses} loading2={loading2} /> */}
                  sasaass
                </TabPanel>
                                ...
                                <div className='table-responsive'>
                                  <table className='table table-bordered vertical-align-top'>
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>Redeemable Loyalty Balance</td>
                                        <td
