...
const Details = ({ course, user }) => {
  ...
  const addToCart = (
    ...
    postCartapi(courseId, tmpnm, image, price, priceos, duration, mode, loyalty)
  }
  ...
  const postCartapi = async (
    ...
    tempcartdata.append('crs_loyalty', loyalpoint)
          ...
          <div className='innercol'>
            ...
            <div className='rowpricecol'>
              ...
              >
                ...
                >
                  <button className='default-btn-green'>Buy Now </button>
                  <button
                    className='default-btn'
                    onClick={() =>
                      addToCart(
