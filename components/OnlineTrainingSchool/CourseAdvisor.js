...
const CourseAdvisor = () => {
	return (
		<div className="advisor-area bg-f9f9f9 pt-100" style={{"background-color":"#000"}}>
			<div className="container">
				<div className="section-title">
					<span className="sub-title">Course Advisor</span>
					<h2 style={{"color":"#fff"}}>Meet Our World-class Instructors</h2>
					<p style={{"color":"#fff"}}>
					...
					<SwiperSlide>
						<div className="single-advisor-item">
							...
							<div className="advisor-content">
								<h3>
									<Link href="/profile">
										<a style={{"color":"#fff"}}>James Andy</a>
									</Link>
								</h3>
