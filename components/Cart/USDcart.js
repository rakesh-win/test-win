              ...
              >
                ...
                <div>
                  <h6 style={{ margin: '0 0 10px 0' }}>
                    Cash & Loyalty Points Redemption
                  </h6>
                        ...
                        <Tooltip
                          ...
                          title={
                            <div>
                              ...
                              <div>
                                Loyalty Points: {loyalPointsInputos || 0}
                              </div>
                              <div>
                                Total: USD{' '}
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontSize: 11, marginBottom: 5 }}>
                    Cash {discountos ? '+ Discount' : ''} <br /> + Loyalty
                    Points
                  </div>
                  <button
                    className={
                    ...
                    style={{
                      position: 'relative',
                      left: 10,
                      display: finalLimit === 0 ? 'none' : 'inline-block'
                    }}
                  >
                    Pay Now
                  </button>
                ...
                (!cartItems2.every(item => item.crs_loyalty === '1') ? (
                  ...
                  <div className='loyalty-container'>
                    <div className='loyalty-message'>
                      You have {finalLimit || '0'} Loyalty Points
                    </div>
                    <div className='loyalty-message'>
