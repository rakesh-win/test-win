...
const Layout = ({ children, user }) => {
    ...
    const fetchSeoData = async () => {
        try {
            ...
            const pathname = window.location.pathname; // Get the current URL
            const matched = data.find(obj => obj.url === 'https://www.winupskill.com' + pathname);
        ...
        if (typeof window !== "undefined") {
            ...
            if (!user2) {
                if (localStorage.getItem("token")) {
                    ...
                    const responseuser = axios.get(url, payload).then(
                        user2 => {
                            setUser2(user2.data)
        ...
        <React.Fragment>
            ...
            {matchedUrls ? (
                ...
                <Head>
                    ...
                    <meta name="msvalidate.01" content="B5019C1715117F4F5E9CD779F6B98CDA" />
                    <meta name="geo.region" content="IN-KA" />
                    <meta name="geo.placename" content="Kanakapura, Bangalore, Karnataka, India" />
