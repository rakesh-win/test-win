                ...
                <div className="container">
                        ...
                        <h3>Enrolled Courses</h3>
                         ...
                         {enrolledCourses.length > 0 ? enrolledCourses.map(enrolledCourse => (
                                 ...
                                 <div className="col-lg-4 col-md-6" key={enrolledCourse.id} style={{display: (enrolledCourse.complstatus === "yes")? 'none' : 'block'}}>
                                    ...
                                    <div className="single-courses-box">
                                        ...
                                        <div className="courses-content">
                                            ...
                                            <ul className="courses-box-footer d-flex justify-content-between align-items-center">
                                                ...
                                                <li>
                                                    <i className='flaticon-people'></i> {enrolledCourse.duration}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        {enrolledCourses.length > 0 ? enrolledCourses.map(enrolledCourse => (
                                 ...
                                 <div className="col-lg-4 col-md-6" key={enrolledCourse.id} style={{display: (enrolledCourse.complstatus === "yes")? 'block' : 'none'}}>
                                    <Link href="/my-courses/view/[id]" as={`/my-courses/view/${enrolledCourse.id}`}>
                                    <div className="single-courses-box">
                                        <div className="courses-image">
                                            <Link href="/my-courses/view/[id]" as={`/my-courses/view/${enrolledCourse.id}`}>
