...
const CoursesDetailsSidebar = dynamic(() => import('@/components/SingleCourses/CoursesDetailsSidebar'));
const YouMightLikeTheCourses = dynamic(() => import('@/components/Courses/YouMightLikeTheCourses'));
import { resetIdCounter, Tab, Tabs, TabList, TabPanel } from "react-tabs";
resetIdCounter();
import axios from "axios";
import baseUrl from "@/utils/baseUrl";
const CoursesCurriculum = dynamic(() => import('@/components/Courses/CoursesCurriculum'));
...
const Details = ({ course, user }) => {
   ...
   useEffect(() => {
        ...
        const filteredCourse = allcourses.find(course => course.previewurl && course.previewurl.includes(`/${slugFromUrl}/`));
    ...
    const filteredFaqData = faqData.filter(item => {
        const courseIds = item.courseid.split(',').map(id => parseInt(id.trim(), 10));
    ...
    return (
        ...
        <React.Fragment>
                ...
                <section className="elementor-section elementor-top-section elementor-element elementor-element-362f6efe elementor-section-height-min-height elementor-section-boxed elementor-section-height-default elementor-section-items-middle" data-id="362f6efe" data-element_type="section">
                    ...
                    <div className="elementor-container elementor-column-gap-default">
                        <div className="elementor-row">
                            ...
                            <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-2af7f22a" data-id="2af7f22a" data-element_type="column">
                                <div className="elementor-column-wrap elementor-element-populated">
                                    <div className="elementor-widget-wrap">
                                        <div className="elementor-element elementor-element-dabebae elementor-widget elementor-widget-image elementor-motion-effects-parent" data-id="dabebae" data-element_type="widget">
                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="courses-details-desc">
                                <Tabs selectedIndex={activeTab} onSelect={setActiveTab}>
                                    ...
                                    <TabPanel style={{ display: subjects.length > 0 ? '' : 'none' }}>
                                        <CoursesCurriculum
                                            videos={subjects}
                                            flag={flaga}
                                        />
            ...
            <div className="container" style={{
                ...
                {configurables.length ? configurables.map((item, index) => (
                    <div className="configurables">
                        <Accordion
                            key={index}
                        ...
                        >
                            ...
                            <AccordionDetails>
                                <Typography><p dangerouslySetInnerHTML={{ __html: item.value }} /></Typography>
                            </AccordionDetails>
                        </Accordion>
                    </div>
                )) : ("")}
                ...
                <div className="row">
                    <div className="innercol">
                        <div className="rowpricecol">
                            ...
                            <span style={{ display: (country === 'India') ? 'block' : 'none' }} className="pricelinebig2">INR {crsprice.elearningindiadisplayprice}</span>
                            <span style={{ display: (country === 'India') ? 'block' : 'none' }} className="pricelinebig">INR {numberWithCommas(crsprice.elearningindiadiscprice)}</span>
                            <span style={{ display: (country !== 'India') ? 'block' : 'none' }} className="pricelinebig2">USD {crsprice.elearningosdisplayprice}</span>
                            <span style={{ display: (country !== 'India') ? 'block' : 'none' }} className="pricelinebig">USD {numberWithCommas(crsprice.elearningosdiscprice)}</span>
                            ...
                            <div className="courses-details-info" style={{ border: "none", marginTop: "0px", marginLeft: "0px" }}>
                                ...
                                <div className="courses-share">
                                    <button className="showbtnastext" onClick={() =>
                                        sendtoEnquiry(
                                            oneCourse.id,
                                            oneCourse.name,
                                            "Self-paced"
                        ...
                        <div className="rowpricecol">
                            ...
                            <span style={{ display: (country === 'India') ? 'block' : 'none' }} className="pricelinebig2">INR {crsprice.lvcindiadisplayprice}</span>
                            <span style={{ display: (country === 'India') ? 'block' : 'none' }} className="pricelinebig">INR {numberWithCommas(crsprice.lvcindiadiscprice)}</span>
                            <span style={{ display: (country !== 'India') ? 'block' : 'none' }} className="pricelinebig2">USD {crsprice.lvcosdisplayprice}</span>
                            <span style={{ display: (country !== 'India') ? 'block' : 'none' }} className="pricelinebig">USD {numberWithCommas(crsprice.lvcosdiscprice)}</span>
                            <span className="priceline seprt"></span>
                        ...
                        <div className="rowpricecol">
                            ...
                            <div className="courses-details-info" style={{ border: "none", marginTop: "100px", marginLeft: "0px" }}>
                                <div className="courses-share">
                                    <button className="default-btn" onClick={() =>
                                        sendtoEnquiry(
                                            oneCourse.id,
            ...
            >
                ...
                <div>
                    {filteredFaqData.length ? filteredFaqData.map((faqItem, index) => (
                        <Accordion key={index}>
                            <AccordionSummary
                            ...
                            >
                                <Typography>
                                    <h4 style={{ fontSize: '19px', fontWeight: 'normal' }}>{faqItem.question}</h4>
                                </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <Typography>
  ...
  {  relatedCourse.length > 0 && <RelatedCourse relatedCourse={relatedCourse} />} 
                    </div>
                </div>
            </div>
